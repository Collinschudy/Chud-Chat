...
const Message = ({handler}) => {
    ...
    const styles = {
        ...
        message: `ml-[1em] bg-gray-100 flex items-center justify-start px-[1em] py-[1em] rounded-bl-[1em] rounded-r-[1em] border border-sky-500`,
        ...
        <div className={styles.container}>
            <div className={`${styles.wrapper} ${handler ? styles.reverse: ''}`}>
                ...
                <div className={`${handler ? styles.messagecontent : styles.contentreverse}`}>
                    <p className={`${handler ? styles.handler : styles.message} mb-[2em]`}>Hello my brother</p>
